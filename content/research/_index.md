...
<ul>
  <li>The use of Deep Learning and Natural Language Processing models in the context of Topic Modeling, Sentiment Analysis and Opinion Mining, aimed at detecting the main topics of discussion, the mood of social media users and their opinion regarding a specific topic/event of interest.</li>
  ...
  <li>The use of machine learning models for data management optimization in scientific workflows, aimed at enabling the realization of large-scale parallel systems for big data analysis.</li>
</ul>
